...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/","login","/register","/saveBlog").permitAll()
                ...
                .antMatchers("/showFormCreDom","/createDom","/findOne/{id}","/saveEdit","/delete","/roomHomepage","/createRoom","/saveRoom","/findOneRoom/{id}","/saveEditRoom","/deleteRoom").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/homepageDom","/roomHomepage","/manageRoom/{id}").authenticated()
                .antMatchers("/bookRoom/{id}","/returnRoom/{id}").access("hasRole('ROLE_USER')")
